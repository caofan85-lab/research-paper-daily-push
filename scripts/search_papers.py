...
OPENALEX_MAX_RESULTS_PER_QUERY = 600
...
def search_openalex(queries: list[str], start: date, end: date) -> list[dict[str, Any]]:
    ...
    for query_index, query in enumerate(queries):
        ...
        while cursor and retrieved_for_query < OPENALEX_MAX_RESULTS_PER_QUERY:
            ...
            remaining = OPENALEX_MAX_RESULTS_PER_QUERY - retrieved_for_query
            ...
            for item in records:
                ...
                article_type = (
                    f"retraction; {work_type}" if item.get("is_retracted") else work_type
                )
            ...
            retrieved_for_query += len(records)
